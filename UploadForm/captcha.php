<?php 
 ...
 $fon_let_amount = 0;          //Количество символов, которые находятся на фоне
 $path_fonts = 'captchaFonts/';        //Путь к шрифтам
 ...
 $fon = imagecolorallocate($src,255,128,0);
 ...
 $results = array(
  'captchaHash' =>hash("md5", implode($cod)),
